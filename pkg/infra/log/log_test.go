...
func TestLogger(t *testing.T) {
	...
	newLoggerScenario(t, "When creating root logger should log as expected", func(t *testing.T, ctx *scenarioContext) {
		...
		require.Equal(t, ctx.mockedTime.Format("2006-01-02T15:04:05.999999-07:00"), ctx.loggedArgs[2][3].(fmt.Stringer).String())
		...
		require.Equal(t, ctx.mockedTime.Format("2006-01-02T15:04:05.999999-07:00"), ctx.loggedArgs[4][3].(fmt.Stringer).String())
...
func TestWithPrefix(t *testing.T) {
	newLoggerScenario(t, "WithPrefix should prepend context to beginning of log message", func(t *testing.T, ctx *scenarioContext) {
		...
		require.Equal(t, ctx.mockedTime.Format("2006-01-02T15:04:05.999999-07:00"), args[5].(fmt.Stringer).String())
...
func TestWithSuffix(t *testing.T) {
	newLoggerScenario(t, "WithSuffix should append context to end of log message", func(t *testing.T, ctx *scenarioContext) {
		...
		require.Equal(t, ctx.mockedTime.Format("2006-01-02T15:04:05.999999-07:00"), args[3].(fmt.Stringer).String())
